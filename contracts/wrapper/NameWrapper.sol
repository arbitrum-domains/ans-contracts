    ...
    IERC721Receiver
{
    ...
    /**
     * @notice Sets records for the subdomain in the ANS Registry
    ...
    {
        ans.setSubnodeRecord(parentNode, label, owner, resolver, ttl);
    }
    ...
    function setSubnodeOwner(
        ...
        returns (bytes32)
    {
        return ans.setSubnodeOwner(parentNode, label, owner);
    }
    ...
    {
        ans.setRecord(node, owner, resolver, ttl);
    }
    ...
    function _checkOwnership(
        ...
        if (ans.owner(node) != address(this)) {
