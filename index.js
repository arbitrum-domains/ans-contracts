...
const ANS = require('./build/contracts/ANS')
const ANSRegistry = require('./build/contracts/ANSRegistry')
const ANSRegistryWithFallback = require('./build/contracts/ANSRegistryWithFallback')
